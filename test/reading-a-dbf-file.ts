...
describe('Reading a DBF file', () => {
    ...
    interface Test {
        ...
        /** Expected language driver ID in the file. */
    ...
    tests.forEach(test => {
        it(`readRecords: ${test.description}`, async () => {
            ...
            if (test.languageDriverId !== undefined) {
                expect(dbf.languageDriverId).equals(test.languageDriverId);
            }
