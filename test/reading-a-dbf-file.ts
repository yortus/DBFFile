...
describe('Reading a DBF file', () => {
    ...
    interface Test {
        ...
        /** The expected date of the last record change. Leave undefined if `error` is defined. */
        updateDate?: Date;
    ...
    let tests: Test[] = [
        {
            ...
            filename: 'PYACFL.DBF',
            recordCount: 45,
            updateDate: new Date("2014-04-13T22:00:00.000Z"),
        ...
        },
        {
            ...
            filename: 'WSPMST.DBF',
            recordCount: 6802,
            updateDate: new Date("1919-05-02T23:00:00.000Z"),
        ...
        },
        {
            ...
            recordCount: 67,
            updateDate: new Date("2003-12-17T23:00:00.000Z"),
            firstRecord: {
                ID: 87,
                CODE: '1',
        ...
        },
        {
            ...
            recordCount: 10,
            updateDate: new Date("2000-06-11T22:00:00.000Z"),
            firstRecord: {
                CHARACTER: 'One',
                NUMERICAL: 1,
                LOGICAL: true,
        ...
        },
        {
            ...
            recordCount: 3,
            updateDate: new Date("1919-11-05T23:00:00.000Z"),
            firstRecord: {
        ...
        },
        {
            ...
            recordCount: 77,
            updateDate: new Date("1902-08-01T23:00:00.000Z"),
    ...
    tests.forEach(test => {
        it(test.description, async () => {
            ...
            let expectedDate = test.updateDate;
            ...
            expect(dbf.lastUpdate, 'last update').deep.equals(expectedDate);
